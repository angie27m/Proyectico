    ...
    <table class="auto-style1">
        <tr>
            ...
            <td class="auto-style14">
                <asp:Label ID="L_Conflictos" runat="server" Text="Conflictos Pendientes"></asp:Label>
            </td>
            <td class="auto-style13"></td>
            <td class="auto-style13"></td>
        </tr>
        ...
        <tr>
            ...
            <td class="auto-style15">
                <asp:GridView ID="GV_Pedido" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="ObjectDataSource5" OnSelectedIndexChanged="GV_Pedido_SelectedIndexChanged" OnRowCommand="GV_Pedido_RowCommand" PageSize="5" OnRowDataBound="GV_Pedido_RowDataBound">
                    <Columns>
                        <asp:TemplateField HeaderText="Seleccionar" ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="LB_Seleccionar" runat="server" CausesValidation="False" CommandName="Select" Text="Seleccionar" CommandArgument='<%# Bind("idpedido") %>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
