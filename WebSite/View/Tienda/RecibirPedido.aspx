    ...
    <table class="auto-style16">
        <tr>
            ...
            <td class="auto-style18">
                <asp:Label ID="L_Pedido" runat="server" Text="Pedidos Recibidos"></asp:Label>
            </td>
            <td class="auto-style22">&nbsp;</td>
            <td class="auto-style10">
                <asp:Label ID="L_Descripcion" runat="server" Text="Descripción del pedido:"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="auto-style21">&nbsp;</td>
            <td class="auto-style18">
                <asp:GridView ID="GV_Asignacion" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" EmptyDataText="Actualice para ver las asignaciones de su sede." OnRowCommand="GV_Asignacion_RowCommand" PageSize="5" OnPageIndexChanging="GV_Asignacion_PageIndexChanging" OnSelectedIndexChanged="GV_Asignacion_SelectedIndexChanged" OnRowDataBound="GV_Asignacion_RowDataBound">
                    <Columns>
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="LB_SeleccionarA" runat="server" CausesValidation="False" CommandName="Select" Text="Seleccionar" CommandArgument='<%# Bind("idasignacion") %>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <td class="auto-style22">
                &nbsp;</td>
            <td>
                <asp:GridView ID="GV_Asignaciones" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" EmptyDataText="Seleccione una asignación." AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="GV_Asignaciones_PageIndexChanging" PageSize="5" OnRowCommand="GV_Asignaciones_RowCommand" OnRowDataBound="GV_Asignaciones_RowDataBound">
                    <Columns>
                        <asp:TemplateField HeaderText="#">
                            <EditItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Seleccionar" ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="LB_SeleccionarAs" runat="server" CausesValidation="False" CommandName='<%#Eval("idasignaciones") + ","+Eval("referencia")+ ","+Eval("talla")+ ","+Eval("cantidad") %>' CommandArgument='<%# Bind("idasignaciones") %>' Text="Conflicto" OnClick="LinkButton1_Click"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                    <FooterStyle BackColor="#99CCCC" ForeColor="#003399" />
                ...
                <table class="auto-style16">
                    <tr>
                        <td>#<br />
                            <asp:Label ID="L_Nume" runat="server"></asp:Label>
                        </td>
                        <td>
        ...
        <tr>
            ...
            <td class="auto-style24">
                <asp:Label ID="L_Tabla" runat="server" CssClass="auto-style25" Text="Tabla Productos con Conflictos"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="auto-style21">&nbsp;</td>
            <td class="auto-style18">
                <asp:Label ID="L_Producto" runat="server" Text="Productos con conflictos:"></asp:Label>
            </td>
            <td class="auto-style22">&nbsp;</td>
            <td class="auto-style10">
        ...
        <tr>
            <td class="auto-style21">&nbsp;</td>
            <td class="auto-style18">
                <asp:Label ID="L_Observaciones" runat="server" Text="Observaciones:"></asp:Label>
            </td>
            <td class="auto-style22">&nbsp;</td>
            <td>
