...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <table class="auto-style1">
            ...
            <tr>
                ...
                <td>&nbsp;</td>
                <td>
                    <asp:GridView ID="GV_Productos" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="ObjectDataSource2" EmptyDataText="No hay productos ingresados." OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowCommand="GV_Productos_RowCommand" CssClass="auto-style10" PageSize="4" OnPageIndexChanged="GV_Productos_PageIndexChanged" OnPageIndexChanging="GV_Productos_PageIndexChanging" OnRowDataBound="GV_Productos_RowDataBound">
                        <Columns>
                            <asp:TemplateField HeaderText="Editar" ShowHeader="False">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LB_Seleccionar" runat="server" CausesValidation="False" CommandName="Editar" Text="Seleccionar" CommandArgument='<%# Bind("idproducto") %>'></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
